...
export default function SVGPreview() {
  const { cardParams, isTyping, paperSize, colorMode, language, decorationMode, setDecorationMode, isGenerating, setGenerating, appMode } = useCardStore();
  ...
  useEffect(() => {
    ...
    // (prompt, theme, mode, paper, real size changes) does.
